...
export const Vacation = () => {
  return <>
    ...
    <Route path="/vacation/worker/saved" element={<VacationFormWorkerSaved />} />
    <Route path="/vacation/department/edit" element={<VacationFormDepartmentEdit />} />
    <Route path="/vacation/department" element={<VacationFormDepartment />} />
    <Route path="/vacation/hr/edit" element={<VacationFormHrEdit />} />
    <Route path="/vacation/hr" element={<VacationFormHr />} />
  </>
};