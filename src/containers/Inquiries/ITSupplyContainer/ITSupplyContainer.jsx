...
import { ITSupplyTable } from "./ITSupplyTable/ITSupplyTable";


export const ITSupplyContainer = () => {
  ...
  const addNewHandleClick = () => navigate("/it-supply/worker/new")
  ...
  return (
    <>
      ...
      <Box padding="16px">
        ...
        <ITSupplyTable data={queries} loading={loading} pagination />
      </Box>
    </>
  );
}